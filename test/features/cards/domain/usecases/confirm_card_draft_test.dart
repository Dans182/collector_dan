...
class _FakeCardRepository implements CardRepository {
  ...
  @override
  Future<Result<void>> deleteCard(String cardId) async => const Success<void>(null);

  @override
  Future<Result<CardEntity>> getCardById(String cardId) async => const Failure('Not implemented');

  @override
  Future<Result<List<CardEntity>>> searchCards(CardSearchFilters filters) async => const Success(<CardEntity>[]);

  @override
  Future<Result<CardEntity>> updateCard(CardEntity card) async => Success(card);
}
